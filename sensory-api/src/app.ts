...
class App {
  ...
  private routes(): void {
    ...
    this.express.put("/api/post", (req, res) => {
      this.postController
        .updatePost(req.body.post, req.body.postInformation, req.body.postStats)
        .then((data: any) => res.json(data));
    });
    ...
    this.express.delete("/api/postinformation/:id", (req, res) => {
      this.postController
        .deletePostInformation(parseInt(req.params.id))
        .then((data: any) => res.json(data));
    });
    ...
    this.express.delete("/api/postcategory/:id", (req, res) => {
      this.postController
        .deletePostCategory(parseInt(req.params.id))
        .then((data: any) => res.json(data));
    });
    ...
    this.express.get("/api/poststats/:id", (req, res) => {
      this.postController
        .getPostStatsById(parseInt(req.params.id))
        .then((data: any) => res.json(data));
    });
    this.express.put("/api/poststats", (req, res) => {
      this.postController
        .createPostStats(req.body.poststats)
        .then((data: any) => res.json(data));
    });
    ...
    this.express.delete("/api/poststats/:id", (req, res) => {
      this.postController
        .deletePostStats(parseInt(req.params.id))
        .then((data: any) => res.json(data));
    });
    ...
    this.express.post("/api/postUpvoteTracker", (req, res) => {
      this.postController
        .postUpvoteTracker(req.body.post, req.body.user_Id)
        .then((data: any) => res.json(data));
    });
    ...
    this.express.post("/api/article", (req, res) => {
      this.articleController
        .createArticle(
          req.body.article,
          req.body.articleInformation,
          req.body.articleStats,
          req.body.fileName
        )
    ...
    this.express.get("/api/getFile/:id", (req, res) => {
      this.articleController
        .getFile(parseInt(req.params.id))
        .then((data: { fileUrl: any }) => {
          try {
            let url = data;
    ...
    this.express.get("/api/getImage/:id", (req, res) => {
      this.articleController
        .getImage(parseInt(req.params.id))
        .then((data: { fileUrl: any }) => {
          try {
            let url = data;
    ...
    this.express.get("/api/articleinformation", (req: any, res: any) => {
      this.articleController
        .getArticleInformations()
        .then((data) => res.json(data));
    });
    this.express.post("/api/articleinformation", (req, res) => {
      this.articleController
        .createArticleInformation(req.body.articleinformation)
        .then((data) => res.json(data));
    });

    this.express.put("/api/articleinformation", (req, res) => {
      this.articleController
        .updateArticleInformation(req.body.articleinformation)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/articleinformation/:id", (req, res) => {
      this.articleController
        .deleteArticleInformation(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/articlestats", (req, res) => {
      this.articleController
        .createArticleStats(req.body.articlestats)
        .then((data) => res.json(data));
    });
    this.express.put("/api/articlestats", (req, res) => {
      this.articleController
        .updateArticleStats(req.body.articlestats)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/articlestats/:id", (req, res) => {
      this.articleController
        .deleteArticleStats(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/articletopic", (req, res) => {
      this.articleController
        .createArticleTopic(req.body.articletopic)
        .then((data) => res.json(data));
    });
    this.express.put("/api/articletopic", (req, res) => {
      this.articleController
        .updateArticleTopic(req.body.articletopic)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/articletopic/:id", (req, res) => {
      this.articleController
        .deleteArticleTopic(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/articleupvotetracker/:id", (req, res) => {
      this.articleController
        .articleUpvoteTracker(req.body.article, parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.delete("/api/message/:id", (req, res) => {
      this.messageController
        .deleteMessage(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/campaign", (req, res) => {
      this.campaignController
        .createCampaign(
          req.body.campaign,
          req.body.campaignInformation,
          req.body.campaignStats
        )
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/campaignsignup", (req, res) => {
      this.campaignController
        .campaignSignUp(req.body.campaign, req.body.userid)
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/campaigninformation", (req, res) => {
      this.campaignController
        .createCampaignInformation(req.body.campaigninformation)
        .then((data) => res.json(data));
    });
    this.express.put("/api/campaigninformation", (req, res) => {
      this.campaignController
        .updateCampaignInformation(req.body.campaigninformation)
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/campaignlist", (req, res) => {
      this.campaignController
        .createCampaignList(req.body.user_Id, req.body.campaign_Id)
        .then((data) => res.json(data));
    });
    this.express.put("/api/campaignlist", (req, res) => {
      this.campaignController
        .updateCampaignList(req.body.campaignlist)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/campaignlist/:id", (req, res) => {
      this.campaignController
        .deleteCampaignList(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/campaignstats", (req, res) => {
      this.campaignController
        .createCampaignStats(req.body.campaignstats)
        .then((data) => res.json(data));
    });
    this.express.put("/api/campaignstats", (req, res) => {
      this.campaignController
        .updateCampaignStats(req.body.campaignstats)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/campaignstats/:id", (req, res) => {
      this.campaignController
        .deleteCampaignStats(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/campaigntopic", (req, res) => {
      this.campaignController
        .createCampaignTopic(req.body.campaigntopic)
        .then((data) => res.json(data));
    });
    this.express.put("/api/campaigntopic", (req, res) => {
      this.campaignController
        .updateCampaignTopic(req.body.campaigntopic)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/campaigntopic/:id", (req, res) => {
      this.campaignController
        .deleteCampaignTopic(parseInt(req.params.id))
        .then((data) => res.json(data));
    });

    // AwarenessTest
    this.express.get("/api/awarenesstest", (req, res) => {
      this.awarenessTestController
        .getAwarenessTest()
        .then((data) => res.json(data));
    });
    this.express.post("/api/awarenesstest", (req, res) => {
      this.awarenessTestController
        .createAwarenessTest(
          req.body.awarenesstest,
          req.body.awarenessteststats
        )
        .then((data) => res.json(data));
    });
    ...
    this.express.delete("/api/awarenesstest/:id", (req, res) => {
      this.awarenessTestController
        .deleteAwarenessTest(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.get("/api/awarenesstestresult", (req, res) => {
      this.awarenessTestController
        .getAwarenessTestResult()
        .then((data) => res.json(data));
    });
    this.express.post("/api/awarenesstestresult", (req, res) => {
      this.awarenessTestController
        .createAwarenessTestResult(req.body.awarenesstestresult)
        .then((data) => res.json(data));
    });
    this.express.put("/api/awarenesstestresult", (req, res) => {
      this.awarenessTestController
        .updateAwarenessTestResult(req.body.awarenesstestresult)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/awarenesstestresult/:id", (req, res) => {
      this.awarenessTestController
        .deleteAwarenessTestResult(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.get("/api/awarenesstesttype", (req, res) => {
      this.awarenessTestController
        .getAwarenessTestType()
        .then((data) => res.json(data));
    });
    this.express.post("/api/awarenesstesttype", (req, res) => {
      this.awarenessTestController
        .createAwarenessTestType(req.body.awarenesstesttype)
        .then((data) => res.json(data));
    });
    this.express.put("/api/awarenesstesttype", (req, res) => {
      this.awarenessTestController
        .updateAwarenessTestType(req.body.awarenesstesttype)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/awarenesstesttype/:id", (req, res) => {
      this.awarenessTestController
        .deleteAwarenessTestType(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.get("/api/comment/:id", (req, res) => {
      this.commentController
        .getCommentById(parseInt(req.params.id))
        .then((data) => res.json(data));
    });

    this.express.get("/api/commentbypost/:id", (req, res) => {
      this.commentController
        .getCommentByPostId(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/comment", (req, res) => {
      this.commentController
        .createComment(
          req.body.comment,
          req.body.commentInformation,
          req.body.commentStats
        )
        .then((data) => res.json(data));
    });
    ...
    this.express.get("/api/commentinformation/:id", (req, res) => {
      this.commentController
        .getCommentInformationById(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    this.express.post("/api/commentinformation", (req, res) => {
      this.commentController
        .createCommentInformation(req.body.commentinformation)
        .then((data) => res.json(data));
    });
    this.express.put("/api/commentinformation", (req, res) => {
      this.commentController
        .updateCommentInformation(req.body.commentinformation)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/commentinformation/:id", (req, res) => {
      this.commentController
        .deleteCommentInformation(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/commentstats", (req, res) => {
      this.commentController
        .createCommentStats(req.body.commentstats)
        .then((data) => res.json(data));
    });
    this.express.put("/api/commentstats", (req, res) => {
      this.commentController
        .updateCommentStats(req.body.commentstats)
        .then((data) => res.json(data));
    });
    this.express.delete("/api/commentstats/:id", (req, res) => {
      this.commentController
        .deleteCommentStats(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.get("/api/userinformation/:id", (req: any, res: any) => {
      this.userController
        .getUserInformationById(parseInt(req.params.id))
        .then((data) => res.json(data));
    });
    ...
    this.express.post("/api/register", (req, res) => {
      this.authController
        .register(req.body.user, req.body.userinformation)
        .then((data) => res.json(data));
    });

    this.express.post("/api/registeradmin", (req, res) => {
      this.authController
        .registerAdmin(req.body.user, req.body.userinformation)
        .then((data) => res.json(data));
    });
    ...
    this.express.get("/api/usertype/:id", (req: any, res: any) => {
      this.userController
        .getUserTypeById(parseInt(req.params.id))
        .then((data) => {
          res.json(data);
        });
    });
