const Terms = () => {
	return (
		<div className="container" style={{marginTop:"40px", marginBottom: "40px", marginLeft: "100px", marginRight: "100px", height: "100%"}}>
			<h1 style={{fontSize:"40px"}}><strong>Terms of Service</strong></h1>
			<hr />
			<div>
				<p><b>1. Who may use the service</b></p>
				<p>You will be allowed to use the service as long as you agree to the terms of service and privacy policy provided on the web 
					application before signing up to SensAware.</p>
				<p><b>2. Privacy</b></p>
				<p>You may read through our <a href='/privacy' style={{color: "blue"}}>Privacy Policy</a> how we handle all the information you provide to us. You understand 
					that by agreeing to the terms of service, you give consent to the collection and use of your information</p>
				<p><b>3. Contents of the Service</b></p>
