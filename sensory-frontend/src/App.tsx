      ...
      <AuthProvider>
        ...
        <Routes>
          ...
          <Route
            path="/article"
            element={
              thisToken && thisUserType === "2" ? <Article /> : <LogIn />
            }
          />
          <Route
            path="/user"
            element={thisToken && thisUserType === "2" ? <User /> : <LogIn />}
          />
          <Route
            path="/article-user"
            element={
              thisToken && thisUserType === "4" ? <ArticleUser /> : <LogIn />
            }
          />
          <Route
            path="/campaign"
          ...
          <Route
            path="/forum-admin"
            element={thisToken ? <AdminForum /> : <LogIn />}
          />
